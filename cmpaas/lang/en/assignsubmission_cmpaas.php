...
/**
 * Strings for component 'assignsubmission_cmpaas', language 'en'
 *
...
$string['allowcmpaassubmissions'] = 'Enabled';
$string['default'] = 'Enabled by default';
$string['default_help'] = 'If set, this submission method will be enabled by default for all new assignments.';
$string['enabled'] = 'CMPAAS';
...
$string['cmpaas'] = 'CMPAAS';
$string['cmpaasfilename'] = 'cmpaas.html';
$string['cmpaassubmission'] = 'Allow online text submission';
$string['pluginname'] = 'CMPAAS';
